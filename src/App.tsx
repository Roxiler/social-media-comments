...
import CommentsIcon from "./components/icons/comment-icon/CommentIcon";
import EditIcon from "./components/icons/edit-icon/EditIcon";
import DeleteIcon from "./components/icons/delete-icon/DeleteIcon";
import "./styles.scss";
import { createComment, deleteComment, getCommentsOnPost, getRepliesOnComments, updateComment } from "./services/comments";
...
function App() {
  ...
  //   posts.then((res) => {
  //     setPostsList(res);
  //     setCommentsList(res[0].comments)
  //   });
  // }, []);
  ...
  const handleDeleteComment = async (postId: any, commentId: any, parentId: any, parentComments: any) => {
  ...
  const handleEditComment = async (postId: string, commentId: any, text: string, parentComments: any) => {
    console.log('ADDING THE COMMENT');
  ...
  const handleAddComment = async (postId: string, parentId: any, text: string, parentComments: any) => {
    console.log('ADDING THE COMMENT');
    console.log("COMMENT: ", text);
    console.log("POST ID: ", postId);
    console.log("PARENT ID: ", parentId);
